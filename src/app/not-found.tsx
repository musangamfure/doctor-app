      ...
      <div className="max-w-screen-xl mx-auto px-4 flex items-center justify-start h-screen md:px-8">
        <div className="max-w-lg mx-auto text-gray-600">
          <div className="space-y-3 text-center">
            <h3 className="text-indigo-600 scroll-m-20 md:text-[6rem] font-extrabold tracking-tight">
              404
            </h3>
            <p className="text-gray-800 text-4xl font-semibold sm:text-3xl">
              Page <span className="text-2xl">: {pathname}</span> not found
            </p>
            <p>
