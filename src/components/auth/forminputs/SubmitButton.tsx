  ...
  return (
    <>
      {isLoading ? (
        ...
        <button
          type={buttonType}
          className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-white dark:text-gray-900 dark:hover:bg-white/85 dark:hover:text-gray-950 dark:focus:ring-white"
        >
          {title}
        </button>
      )}
