...
const DoctorCard = ({
  ...
  return (
    <div className="max-w-sm rounded-md border dark:bg-neutral-950 border-gray-200 hover:border-gray-400 duration-300 shadow-sm p-4 bg-white ">
      <Link href="/doctors/slug">
        <div className="">
          <div>
            <h2 className="text-xl font-bold">{name}</h2>
            {isInPersonal && (
              <p className="text-gray-600 dark:text-white/65">{address}</p>
            )}
          </div>
        </div>
